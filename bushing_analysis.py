...
def get_f2(temperature, foreign_matter):
    ...
    if temperature <= 140:
        if foreign_matter is False:
            # unsure 
            slope = (6.0 - 3.0) / (140.0 - 0)
            f2 = slope * (temperature - 0) + 3.0
        else:
            f2 = 1.0

    elif temperature <= 210:
        if foreign_matter is False:
            slope = (6.0 - 3.0) / (210.0 - 140.0)
            f2 = slope * (temperature - 140.0) + 3.0
        else:
            slope = (12.0 - 6.0) / (210.0 - 140.0)
            f2 = slope * (temperature - 140.0) + 6.0
